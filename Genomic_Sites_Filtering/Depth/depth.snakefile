...
# all_bed: path to bed file with all sites (i.e. for each chromosome included "chr start end" where start is 0 and end is lenght of chromosome). Created using faSize -tab -detailed and sed "s/\t/\t0\t/g" REF.sizes > REF.bed
# chroms: list of chromosomes to do depths on. Created using cut -f 1 REF.bed
...
COMBINE="combineDepths.R"
PLOT="plotDepths.R"
FILTER="doDepthFilter.py"
