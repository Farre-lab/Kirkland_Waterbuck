"""
ADDED -rmtrans 1 to remove transitions
...
rule do_beagle_perchrom:
    ...
    params:
        ...
        r = "{chrom}"
    shell:"""
    {ANGSD} -GL 2 -bam {input.bams} -sites {input.regions} -r '{params.r}' -out '{params.outprefix}' -minMapQ {MINMAPQ} -minQ {MINQ} -doGlf 2 -doMajorMinor 1 -doMaf 1 -SNP_pval 1e-6 -minMaf 0.05 -rmtrans 1
"""
